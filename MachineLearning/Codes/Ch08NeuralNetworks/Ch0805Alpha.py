...
mlp_alpha = MLPClassifier(solver='lbfgs', hidden_layer_sizes=[
                          10, 10], activation='tanh', alpha=1, random_state=16)
...
# 设置图的标题，并显示图形
plt.title(
    "MLPClassifier: solver=lbfgs, activation=tanh, nodes=[10, 10], alpha=1")
plt.show()
