...
plt.title('图2: MinMaxScaler')


plt.legend(loc='best')
plt.savefig('Codes//Ch09Preprocessing//results//Ch0902MinMaxScaler.png', dpi=150)
plt.show()
